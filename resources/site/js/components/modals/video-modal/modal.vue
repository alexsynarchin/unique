<template>
    <div class="modal fade unique-modal" id="video_modal"  tabindex="-1" role="dialog"  aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered unique-modal__dialog" role="document">
            <div class="unique-modal__content modal-content video-modal__content">
                ...
                <iframe width="100%" height="315" :src="url" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"></iframe>
        </div>
    </div>
    </div>
</template>
...
export default {
    ...
    mounted() {
        var myModalEl = document.getElementById('video_modal');
        let vm = this;
