...
return [
    ...
    */
    ...
    |
    */
    'secret_key' => env('RECAPTCHA_V3_SECRET_KEY', '6LcWYIUmAAAAABC_6zinZyBiXgCUgN5L8U_RzwTS'),
    /*
    |--------------------------------------------------------------------------
    | Site Key
    |--------------------------------------------------------------------------
    ...
    |
    */
    'site_key' => env('RECAPTCHA_V3_SITE_KEY', '6LcWYIUmAAAAACj3pRbN6FL2iOTUMIjk9LPZSkMr'),
